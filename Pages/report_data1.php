...
<div class="table-container">   
    <table class="table table-bordered text-center table-striped table-hover mb-0" id="ctickettable">
        ...
        $sql=" WITH pqr as(SELECT COUNT(*) AS cnt, ticketid
                ...
                SELECT top 200 a.istransfer as a,u.istransfer,u.ticketid,a.srno,a.priority,t.srno as tsr,t.pstop,format(t.date,'dd-MM-yyyy') as cdate,t.username,t.mcno,t.department,t.plant,t.issue,t.remark as remarkc,a.ticket_id,a.assign_to,
